    ...
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="receive_name">ชื่อ-นามสกุล ผู้รับ <span class="text-danger">*</span></label>
                        <input data-name="ชื่อ-นามสกุลผู้รับ" type="text" id="receive_name" name="receive_name" class="form-control" placeholder="ขื่อ ...">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="receive_mobile">เบอร์โทรศัพท์ <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="pickup_type">วิธีจัดส่ง</label>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- textarea -->
                    <div class="form-group">
                        <label for="receive_address">ที่อยู่ ผู้รับ <span class="text-danger varidate-receive-address">*</span></label>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <!-- select -->
                    <div class="form-group">
                        <label for="receive_province">จังหวัด <span class="text-danger varidate-receive-address">*</span></label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="receive_amphure">อำเภอ <span class="text-danger varidate-receive-address">*</span></label>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <!-- select -->
                    <div class="form-group">
                        <label for="receive_district">ตำบล <span class="text-danger varidate-receive-address">*</span></label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="receive_zip_code">รหัสไปรษณีย์ <span class="text-danger varidate-receive-address">*</span></label>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <!-- textarea -->
                <div class="form-group">
                    <label for="parcel_description">ข้อมูลพัสดุ <span class="text-danger">*</span></label>
       ...
       <div class="row">
            <div class="col-sm-6">
                <!-- textarea -->
                <div class="form-group">
                    <label for="payment_type1">ช่องทางการชำระเงิน <span class="text-danger">*</span></label>
                    <div class="custom-control custom-radio">
            ...
            <div class="col-sm-6">
                <div class="form-group ">
                    <label for="parcel_pice">จำนวนเงิน/ราคา <span class="text-danger">*</span></label>
